      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Explore Our <span className="text-red-600">World</span>
          </h2>
                ...
                <div className="relative h-full overflow-hidden rounded-2xl shadow-elegant hover:shadow-elegant-lg transition-all duration-500 bg-white/95 backdrop-blur-sm transform hover:-translate-y-2 border border-gray-100/70 group">
                  <div className="relative h-56">
                    ...
                    <div className="absolute bottom-4 left-6 text-white">
                      <h3 className="text-xl sm:text-2xl font-bold mb-1 tracking-tight">{highlight.title}</h3>
                      <div className="h-1 w-12 bg-white/40 rounded-full group-hover:w-20 transition-all duration-500" />
                    </div>
                  </div>
                  
                  <div className="p-8 flex flex-col min-h-[180px]">
                    <p className="text-gray-600 mb-6 line-clamp-3 text-sm sm:text-base leading-relaxed font-light">
                      {highlight.description}
                    </p>
                    <div className="mt-auto flex items-center text-red-600 font-bold group-hover:text-red-700 transition-colors duration-200 uppercase text-xs tracking-widest">
        ...
        >
          <a
            ...
            className="group flex items-center gap-5 bg-gray-900 hover:bg-black rounded-2xl p-5 sm:p-6 shadow-elegant hover:shadow-elegant-lg transition-all duration-500 border border-gray-700/50 hover:border-red-600/40"
          >
            <div className="flex-shrink-0 w-14 h-14 bg-red-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
        ...
        >
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
            <Link
              href="/gallery"
              className="bg-white hover:bg-gray-100 text-gray-700 hover:text-red-600 px-4 sm:px-6 py-2 sm:py-3 rounded-full font-semibold text-sm sm:text-base shadow-elegant hover:shadow-elegant-lg transition-all duration-300 transform hover:-translate-y-1"
            >
              View Gallery
            </Link>
            <Link

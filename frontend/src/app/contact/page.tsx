  ...
  const faqData = [
    {
      ...
      answer: "We welcome partnerships from organizations that share our vision of promoting Kenyan culture globally. Please contact us through our partnership inquiry form or email us directly at info@misscultureglobalkenya.com"
    },
    {
    ...
    },
    {
      ...
      answer: "Yes, we welcome media inquiries and interviews. Please contact our team at info@misscultureglobalkenya.com with your request, including the topic, format, and preferred timeline."
    },
    {
    ...
    },
    {
      ...
      answer: "We typically respond to all inquiries within 24-48 hours during business days. For urgent matters, please call us directly at +254 721 706983."
    }
  ]
              ...
              <form className="space-y-6" onSubmit={async (e) => {
                ...
                {submitStatus === 'success' && (
                  <div className="bg-green-50 border border-green-200 rounded-xl p-4">
                    <p className="text-green-700 font-medium">Your message has been sent successfully! We will get back to you soon.</p>
                  </div>
                )}
                {submitStatus === 'error' && (
                  <div className="bg-red-50 border border-red-200 rounded-xl p-4">
                    <p className="text-red-700 font-medium">Failed to send message. Please try again or email us directly at info@misscultureglobalkenya.com</p>
                  </div>
                )}
